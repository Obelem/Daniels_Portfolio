...
// const intros = document.querySelectorAll('.fancy');
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  //     leftIntro.innerHTML = `<h2 class="title">Hi, I'm <span class="fancy">Daniel</span></h2>`;
  //     rightIntro.innerHTML = `<h2 class="title">Engr.  <span class="fancy">Daniel</span></h2>`;
  //   }
